...
LastEditTime: 2022-04-01 20:00:27
'''

import networkx as nx
from .graph_cluster.community_louvain import best_partition, modularity
from utils.plots import display_train_stats
from utils.plots import display_train_stats, graph_split_visualization, clear_graph_pic_dir 
import copy
    ...
    # c_round为当前的通信轮数
        ...
        if c_round > 20:    
            ...
            if cur_mod > pre_mod:
                ...
                #print("我划分了")
                graph_split_visualization(graph, par_idcs, similarities, c_round, 0)
