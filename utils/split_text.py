...
To run call preprocess_shakespeare with arg of file root_path,
the file will be read from path/Shakespacre/raw/shakespeare.txt 
and saved to path/Shakespare/processed
...
def split_into_plays(shakespeare_full):
...
def get_train_test_by_character(plays, test_fraction=0.2):
    """
